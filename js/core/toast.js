...
export function toastCatAdded({ breed, name, sprite_url }) { /* ...unchanged... */ }
export function toastCancelled() { /* ...unchanged... */ }
export function toastBought(name) { /* ...unchanged... */ }
export function toastNotEnough() { /* ...unchanged... */ }
export function toastEquipResult(name, result) { /* ...unchanged... */ }
export function toastInfo(text, background = "#ffcc66") { /* ...unchanged... */ }
export function toastSimple(text, background = "#4caf50") { /* ...unchanged... */ }
export function toastConfirmDelete(cat, onConfirm, onCancel) { /* ...unchanged... */ }
export function toastNoCats() { /* ...unchanged... */ }
export async function toastCatFact() { /* ...unchanged... */ }
