...
# Your task:
I need you to change the SENT: When clicking a conversation we currently have a "type message..." for player. What we need to add is the conversation messages history. Understood?
